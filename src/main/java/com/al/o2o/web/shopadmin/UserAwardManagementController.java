...
import com.al.o2o.dto.UserAwardMapExecution;
import com.al.o2o.dto.WechatInfo;
import com.al.o2o.entity.*;
import com.al.o2o.enums.UserAwardMapStateEnum;
import com.al.o2o.service.PersonInfoService;
import com.al.o2o.service.ShopAuthMapService;
import com.al.o2o.service.UserAwardMapService;
...
public class UserAwardManagementController {
	...
	private boolean checkShopAuth(long userId, UserAwardMap userAwardMap) {
		...
		ShopAuthMapExecution shopAuthMapExecution = shopAuthMapService
				.getShopAuthMapListByShopId(userAwardMap.getShop().getShopId(), 1, 1000);
